...
export function calculatePreparedness(answers: Answers): PreparednessResult {
  ...
  // 優先順位つきの判定リスト
  const checks = [
    { key: "q1", condition: answers["q1"] === "no", image: "/picture/result_picture/type1.png" },
    { key: "q2", condition: answers["q2"] === "no", image: "/picture/result_picture/type2.png" },
    { key: "q3", condition: answers["q3"] === "no", image: "/picture/result_picture/type3.png" },
    { key: "q4", condition: answers["q4"] === "no", image: "/picture/result_picture/type4.png" },
    { key: "stockpile", condition: stockpile <= 3, image: "/picture/result_picture/type5.png" },
  ];
